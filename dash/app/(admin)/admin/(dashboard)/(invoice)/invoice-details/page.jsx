        ...
        <div className="col-span-12 xl:col-span-8">
          <Card>
            <CardContent>
              <div className="flex gap-6 flex-col md:flex-row pt-8">
                <div className="flex-1">
                  <Link href="#">
                    ...
                    <span className="text-3xl font-bold text-primary-600">Logica Portals</span>
                  </Link>
                  <div className="mt-5">
              ...
              <div className="text-xs text-default-800 mt-2">Logica Portals@best.com</div>
              <div className="text-xs text-default-800 mt-1">+880 624279888</div>
              <div className="mt-8 text-xs text-default-800">© 2024 Logica Portals</div>
            </CardContent>
          </Card>
