...
import OutlineWithoutTextTimeline from "./outline-without-text-timeline";
import LineSpaceWithoutTextTimeline from "./line-space-without-text-timeline";
...
import {
  ...
  leftTimeline,
  lineSpaceTimeline,
  lineSpaceWithoutTextTimeline,
  outlineWithoutTextTimeline,
  outlinedTimeline,
  pingAndLineSpace,
  timelineWithCard,
  timelineWithIcon,
  ...
  return (
    <div className="space-y-5">
      ...
      <Card title="Left Timeline" code={leftTimeline}>
        <p className="text-sm text-default-500  mb-4">
          Use <span className="text-primary"></span> props on timeline component to display left align timeline.
        </p>
      ...
      <Card title="Alternative Timeline" code={alternativeTimeline}>
        <p className="text-sm text-default-500  mb-4">
          Use <span className="text-primary"></span> props on timeline component to display alternative timeline.
        </p>
        <AlternativeTimeline />
      </Card>
      <Card title="Alternative Reverse Timeline" code={alternativeReverseTimeline} >
        <p className="text-sm text-default-500  mb-4">
          Use <span className="text-primary"> </span> props on timeline component to display alternate-reverse timeline.
        </p>
        <AlternativeReverseTimeline />
      </Card>
      ...
      <Card
        title="Line Without Text Space Timeline"
        code={lineSpaceWithoutTextTimeline}
      >
        <p className="text-sm text-default-500  mb-4">
          Apply the <span className="text-primary">gap</span> prop on the Timeline component to introduce spacing between timeline items.
        </p>
        <div className="w-full flex justify-center items-center">
          <LineSpaceWithoutTextTimeline />
        </div>
      ...
      <Card
        title="Outline Without Text Timeline"
        code={outlineWithoutTextTimeline}
      >
        <p className="text-sm text-default-500  mb-4">
          Apply the <span className="text-primary">variant</span> prop on the TimelineDot component to implement an outlined style for the dots.
        </p>
        <div className="w-full flex justify-center items-center">
          <OutlineWithoutTextTimeline />
        </div>
      ...
      <Card title="Timeline With Icon" code={timelineWithIcon}>
        <p className="text-sm text-default-500  mb-4">
          Utilize the  variant <span className="text-primary"> variant</span> on the TimelineDot component to place an icon on the timeline.
        </p>
        <TimelineWithIcon />
      </Card>
