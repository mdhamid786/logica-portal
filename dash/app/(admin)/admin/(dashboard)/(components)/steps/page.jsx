...
import VStepsLineSpace from "./v-linspace";
    ...
    <div className="space-y-5">
      ...
      <Card title="With Data Content" code={stepsWithDataContent}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          component makes content in  to show in different
          steps.
        </p>
        <StepsWithDataContent />
      </Card>
      <Card title="Content With Action Step" code={stepsWithAction}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          function stepper component makes content in  to
      ...
      <Card title="Error Alert Step" code={errorAlertSteps}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          ...
          component with value  makes label and node with destructive
