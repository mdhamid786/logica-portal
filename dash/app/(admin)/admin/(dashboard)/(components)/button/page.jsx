  ...
  return (
    <div className=" space-y-5">
      ...
      <Card title="Outline Buttons" code={outlineButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary"> variant </code> prop is
      ...
      <Card title="Soft Buttons" code={softButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">variant</code> prop is used
      ...
      <Card title="Icon Buttons" code={iconButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">size</code> props design
      ...
      <Card title="Block Buttons" code={blockButton}>
        ...
        <div className="grid xl:grid-cols-2  grid-cols-1 gap-5">
          ...
          <div className=" space-y-4">
            ...
            <Button className="w-full" color="success" variant>
              <Icon
            ...
            <Button className="w-full" color="warning" variant>
              Icon Right Outline
      ...
      <Card title="Social Buttons" code={socialButton}>
        <p className="text-sm text-default-400 dark:text-default-600  mb-4">
          The <code className="text-primary">size</code> props design the
          button with icon
        </p>
