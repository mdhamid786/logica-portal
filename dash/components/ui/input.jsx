...
export const inputVariants = cva(
  " w-full   bg-background  border-default-300 dark:border-700  px-3 h-9   text-sm  file:border-0 file:bg-transparent file:text-sm file:font-medium  read-only:leading-9 read-only:bg-background  disabled:cursor-not-allowed disabled:opacity-50  transition duration-300 ",
  {
    variants: {
      color: {
        default:
          "border-default-300 text-default-500 focus:outline-none focus:border-black disabled:bg-default-200  placeholder:text-accent-foreground/50",
        black:
          "border-black text-black focus:outline-none focus:border-black-700 disabled:bg-black/30 disabled:placeholder:text-black  placeholder:text-black/70",
    ...
    compoundVariants: [
      {
        variant: "flat",
        color: "black",
        className: "bg-black/10 read-only:bg-black/10",
      },
      {
        variant: "flat",
        color: "info",
      ...
      },
      {
        ...
        color: "black",
        className:
          "bg-black/10 border-black/30 read-only:bg-black/10 border-black/30",
      },
      {
        variant: "faded",
        color: "info",
